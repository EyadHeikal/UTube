...
//        let query = GTLRYouTubeQuery_ActivitiesList.query(withPart: "contentDetails")
//        query.home = true
//        let res = service.executeQuery(query, delegate: self, didFinish: nil)
//        print(res.fetchedObject)
//        let response = GTLRYouTube_ActivityListResponse()
